...
class RowAndCoins {
    ...
    string getWinner(string cells) {
        string no = "Bob", yes = "Alice";
        if (cells[0] == 'A' || cells[sz(cells)-1] == 'A') return yes;
        return no;
    }
};
...
bool do_test(string cells, string __expected, int caseNo) {
...
bool run_testcase(int __no) {
    switch (__no) {
        case 0: {
            ...
            return do_test(cells, __expected, __no);
        }
        case 1: {
            string cells = "BBBB";
